    ...
    try:
        ...
        def _extract_source_sentences_batch(
            ...
            source_sentence_prompt_sections: List[str] = [
                "タスク: 以下の日本語原文 (source_text) を読み、同じ話題や関連語を含む参照資料本文の文を抽出してください。",
                "",
                "進め方:",
                "- context_id ごとに固有名詞・数値・年月・施策名・重要語（名詞/動詞/形容詞/副詞/接続詞など）を手がかりに、指定された参照URLの本文から関連度の高い段落を探してください。",
                "- 意味や論点が完全一致しなくても、語彙や言い回しが関連すると判断できる文は候補に含め、関連度の高い順に最大10文まで収集してください。",
