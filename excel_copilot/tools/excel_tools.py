    ...
    try:
        ...
        def _extract_source_sentences_batch(
            ...
            source_sentence_prompt_sections: List[str] = [
                "以下の入力に基づき、翻訳対象の日本語原文と関連度が高い参照資料本文の文を抽出してください。",
                "",
                "手順:",
                "- 各 context_id について、source_text に含まれる内容を手掛かりに参照URLを開き、原文の主題・用語・事実と関連性が高い本文の文を最大6文まで特定する。",
