    ...
    try:
        ...
        if include_context_columns:
            prompt_parts = [
                ...
                "Use only the provided reference_pairs as supporting evidence. Do not invent information, fabricate supporting sentences, or rely on any material outside these pairs.\n",
        ...
        def _extract_source_sentences_batch(
            ...
            source_sentence_prompt_sections: List[str] = [
                ...
                "- 必ず参照資料本文に実際に存在する文をそのまま引用し、新たに文章を生成したり要約文を作成しない。",
        ...
        def _pair_target_sentences_batch(
            ...
            pairing_prompt_sections: List[str] = [
                ...
                "- 必ず参照資料に実際に存在する文をそのまま引用し、新たに文章を生成したり書き換えたりしない。",
