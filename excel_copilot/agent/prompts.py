...
_REVIEW_PROMPT = (
    ...
    "- 明らかな誤訳や欠落だけでなく、語調・自然さ・専門性・用語統一といった翻訳表現の質も丁寧に点検し、必要であれば改善案を提示してください。\n\n"
    "Response format\n"
    ...
    "  * `Issue` では文意が通じていても改善余地がある表現（語順・語調・ニュアンス・ドメイン適合など）も積極的に指摘してください。\n"
    "  * `Suggestion` には、自然で読みやすくプロフェッショナルな訳語になるような具体的な修正案を記述してください。\n"
